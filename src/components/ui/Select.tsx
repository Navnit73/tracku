      ...
      <div className="w-full flex flex-col gap-1.5">
        ...
        <div className="relative flex items-center w-full">
          <select
            ...
            ref={ref}
            className={cn(
              "w-full appearance-none rounded-xl border border-hairline bg-surface px-3.5 py-2.5 sm:py-2 pr-10 text-base sm:text-sm text-ink transition-all duration-200 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 cursor-pointer min-h-[44px] sm:min-h-[40px] disabled:opacity-50 disabled:bg-canvas",
          ...
          <div className="absolute right-3.5 text-ink-faint pointer-events-none flex items-center justify-center">
